...
const register_login = () =>{
  ...
  const register_account = sessionStorage.getItem("register_account")
  const register_password = sessionStorage.getItem("register_password")
  axios
  .post('/japi/stu13/quasar2/api/abc/register/login', {
  ...
  .then((response1) => {
    ...
    if (response1.status === 200) {
      setOnline(true);
      sessionStorage.setItem('login', 'true');
      sessionStorage.setItem("password", register_password)
      sessionStorage.setItem("account", register_account)
      axios
        .post('/japi/stu13/quasar2/api/abc/register/getdata', {
          name: register_account,
          password: register_password,
    ...
    <div>
      ...
      {online || sessionStorage.getItem('login') === 'true' ? (
        ...
        <div>
          ...
          <TabsChoicecopy register_login = {register_login}/>
        </div>
      )}
    </div>
  );
